...
export default function DashboardPage() {
  ...
  useEffect(() => {
    ...
    if (!storedToken || !storedRole || !storedPermissions) {
      router.push("/Login");
      return;
    }
  ...
  const canAddHospital = permissions.includes("add_hospital");
            ...
            <div className="text-center text-gray-400">
              ...
              <p className="text-sm">
                {canAddHospital
                  ...
                  : "You don't have permission to add hospitals"}
              </p>
            </div>
          </div>
        )}
              ...
              <div className="p-10 md:p-12">
                <div className="text-center mb-10">
                  ...
                  <p className="text-gray-600 text-lg md:text-xl leading-relaxed max-w-3xl mx-auto">
                    Begin your journey by registering a hospital to unlock
                    comprehensive management tools for doctors, staff,
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
                  ...
                  <div className="bg-gradient-to-br from-indigo-50 to-indigo-100 p-6 rounded-xl border border-indigo-200 flex flex-col items-center text-center">
                    ...
                    <p className="text-sm text-gray-600">
                      Coordinate doctors, nurses, and support staff
                      efficiently
                    </p>
                  </div>
              ...
              <div className="flex flex-col md:flex-row items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-600 leading-relaxed">
                    After adding a hospital, you'll be able to create users,
                    assign staff members, manage roles and permissions, and
                    start scheduling appointments immediately. All your hospital
                    data will be securely stored and easily accessible.
                  </p>
                </div>
              </div>
            </div>
